"""
Django settings for editoria_service project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '94.182.189.110', 'editoraai.ir', 'www.editoraai.ir', 'editoraai.com', 'www.editoraai.com']
